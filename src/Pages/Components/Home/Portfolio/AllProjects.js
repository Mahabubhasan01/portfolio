...
const AllProjects = () => {
  return (
    <div class="bg-slate-900 portfolio-2 py-6 md:py-12">
      ...
      <div class="md:flex md:justify-center">
        <div class="md:w-10/12 xl:w-8/12 text-center">
          <div class="mt-6">
            <button class="bg-indigo-600 border-2 border-solid border-indigo-600 hover:bg-indigo-700 hover:border-indigo-700 text-white rounded-full py-3 px-8 transition-colors duration-300 mx-2 ">
              View MORE Portfolio
            </button>
      ...
      <div class="sm:flex sm:flex-wrap sm:-mx-4 mt-6 md:mt-12 pb-6 ">
        <div class="sm:px-6 sm:w-1/2 lg:w-1/3 mt-8 rounded-lg">
