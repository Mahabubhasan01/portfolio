...
const Star = ({text}) => {
    return (
        <div className='p-10 -mb-10'>
            <h1 className="text-center uppercase text-pink-400 text-4xl font-bold  leading-none tracking-normal">
              {text}
            </h1>
            <div className="flex flex-row items-center justify-center py-4">
              <span className="h-1 w-24 bg-pink-400 rounded-full mx-2"></span>
              <svg
                className="h-12 fill-current text-pink-400"
